            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Silapor</span>
                </a>
              </div>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Lengkapi Form untuk Register</p>
                  </div>
                  <form class="row g-3 needs-validation" method="POST" action="simpan_masyarakat.php" novalidate>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                    <label for="yourPassword" class="form-label">No. Telepon</label>
                      <input type="text" name="telp" class="form-control" id="yourUsername" required>
                      <div class="invalid-feedback">No. Telepon Masih Kosong.</div>
                    </div>
                    <div class="col-12">
                    </div>
                    ...
                    <div class="col-12">
                  <br>
                    <p class="small mb-0">Sudah Punya Akun? <a href="index.php">Silahkan Login.</a></p>
                  </div>
                  </form>
                </div>
              </div>
