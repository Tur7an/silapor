            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="POST" action="cek_login.php" novalidate>
                  ...
                  <div class="col-12">
                  <p class="small mb-0">Belum Punya Akun? <a href="register.php">Daftar Akun</a></p>
                  </div>
